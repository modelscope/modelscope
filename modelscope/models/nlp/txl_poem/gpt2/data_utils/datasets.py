        ...
        if self._lens is None:
            ...
            if self.is_lazy:
                for data in self.datasets:  # noqa
                    self._lens.extend(data.lens)  # noqa
            else:
...
class bert_sentencepair_dataset(data.Dataset):
    ...
    Arguments:
        ...
        max_preds_per_seq (int): Maximum number of masked tokens per sentence pair. Default: math.ceil(max_seq_len*mask_lm_prob/10)*10 # noqa
