...
from modelscope.outputs import OutputKeys, MachineReadingComprehensionOutput
...
@PIPELINES.register_module(
    Tasks.machine_reading_comprehension, module_name=Pipelines.machine_reading_comprehension_for_ner)
class MachineReadingComprehensionForNERPipeline(Pipeline):
    ...
    def forward(self, inputs,
                **forward_params) -> Union[Dict[str, Any], MachineReadingComprehensionOutput]:
        with torch.no_grad():
    ...
    def postprocess(self,
                    inputs: Union[Dict[str, Any],
                                  MachineReadingComprehensionOutput]) -> Dict[str, Any]:
