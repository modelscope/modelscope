...
from modelscope_hub.compat.constants import (  # noqa: F401
    DEFAULT_CREDENTIALS_PATH, DEFAULT_DATASET_REVISION, DEFAULT_MAX_WORKERS,
    DEFAULT_MODELSCOPE_DATA_ENDPOINT, DEFAULT_MODELSCOPE_DOMAIN,
    DEFAULT_MODELSCOPE_GROUP, DEFAULT_MODELSCOPE_INTL_DATA_ENDPOINT,
    DEFAULT_MODELSCOPE_INTL_DOMAIN, DEFAULT_SKILLS_DIR, FILE_HASH,
    MODEL_ID_SEPARATOR, MODELSCOPE_DOMAIN, MODELSCOPE_PREFER_AI_SITE,
