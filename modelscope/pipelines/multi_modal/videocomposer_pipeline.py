...
from modelscope.models.multi_modal.videocomposer.data.transforms import random_resize
from modelscope.models.multi_modal.videocomposer.data.transforms import CenterCrop
from modelscope.models.multi_modal.videocomposer.random_mask import (make_irregular_mask, make_rectangle_mask, make_uncrop)
...
class VideoComposerPipeline(Pipeline):
    ...
    def preprocess(self, input: Input) -> Dict[str, Any]:
        ...
        print("---------ref_frame, cap_txt, video_data, misc_data, feature_framerate, mask, mv_data", ref_frame, cap_txt, video_data, misc_data, feature_framerate, mask, mv_data)
