...
class GPT3OneLayerQAandCW():
    ...
    def __init__(self, subtask, tp, work_dir):
        ...
        self.tp = tp
        dataset_name = {
            'qa': 'DuReader_robust-QG',
            'cw': 'chinese-poetry-collection'
        }
...
gpt3_one_layer_cw_tp_1 = GPT3OneLayerQAandCW(
    subtask='cw', tp=1, work_dir='./gpt3_poetry_tp_1')
...
def finetune_poetry_tp_1():
    ...
    gpt3_one_layer_cw_tp_1.finetune(
...
def pipeline_poetry_tp_1():
    ...
    with open(
            fr'{gpt3_one_layer_cw_tp_1.work_dir}/gpt3_1_layer_base_tp1_cw_pipeline_gen_text.txt',
            'w',
            encoding='utf-8') as f:
        f.write(gen_content)
...
gpt3_one_layer_qa_tp_1 = GPT3OneLayerQAandCW(
    subtask='qa', tp=1, work_dir='./dureader_tp_1')
...
def finetune_dureader_tp_1():
    ...
    gpt3_one_layer_qa_tp_1.finetune(
        max_epochs=max_epochs, cfg_modify_fn=cfg_modify_fn)
...
def pipeline_dureader_tp_1():
    ...
    with open(
            fr'{gpt3_one_layer_qa_tp_1.work_dir}/gpt3_1_layer_base_tp1_qa_pipeline_gen_text.txt',
            'aw',
            encoding='utf-8') as f:
