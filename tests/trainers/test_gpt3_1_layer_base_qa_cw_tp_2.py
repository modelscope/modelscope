...
gpt3_one_layer_cw_tp_2 = GPT3OneLayerQAandCW(
    subtask='cw', tp=2, work_dir='./gpt3_poetry_tp_2')
...
def finetune_poetry_tp_2():
    ...
    gpt3_one_layer_cw_tp_2.finetune(
...
def pipeline_poetry_tp_2():
    ...
    with open(
            fr'{gpt3_one_layer_cw_tp_2.work_dir}/gpt3_1_layer_base_tp2_cw_pipeline_gen_text.txt',
            'w',
            encoding='utf-8') as f:
        f.write(gen_content)
...
gpt3_one_layer_qa_tp_2 = GPT3OneLayerQAandCW(
    subtask='qa', tp=2, work_dir='./dureader_tp_2')
...
def finetune_dureader_tp_2():
    ...
    gpt3_one_layer_qa_tp_2.finetune(
        max_epochs=max_epochs, cfg_modify_fn=cfg_modify_fn)
...
def pipeline_dureader_tp_2():
    ...
    with open(
            fr'{gpt3_one_layer_qa_tp_2.work_dir}/gpt3_1_layer_base_tp2_qa_pipeline_gen_text.txt',
            'aw',
            encoding='utf-8') as f:
