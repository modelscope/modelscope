...
@MODELS.register_module(
    Tasks.punctuation, module_name=Models.funasr)
@MODELS.register_module(
    Tasks.speaker_diarization, module_name=Models.funasr)
@MODELS.register_module(
    Tasks.speaker_verification, module_name=Models.funasr)
@MODELS.register_module(
    Tasks.speech_separation, module_name=Models.funasr)
@MODELS.register_module(
    Tasks.speech_timestamp, module_name=Models.funasr)
@MODELS.register_module(
    Tasks.emotion_recognition, module_name=Models.funasr)
