...
from gaussian_renderer.scene.colmap_loader import read_extrinsics_text, \
    read_intrinsics_text, qvec2rotmat, \
    read_extrinsics_binary, read_intrinsics_binary, \
    read_points3D_binary, read_points3D_text

from gaussian_renderer.scene.gaussian_model import BasicPointCloud

from gaussian_renderer.utils import getWorld2View2, focal2fov, fov2focal, SH2RGB
...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder):
    ...
    for idx, key in enumerate(cam_extrinsics):
        ...
        sys.stdout.write("Reading camera {}/{}".format(
            idx + 1, len(cam_extrinsics)))
        sys.stdout.flush()
