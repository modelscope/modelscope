...
docker_file_content="${docker_file_content} \nRUN export COMMIT_ID=$BUILD_HASH_ID && pip install --no-cache-dir -U adaseq pai-easycv &&  pip install --no-cache-dir -U 'ms-swift==1.7.1' 'funasr==1.0.14' autoawq 'timm>0.9.5' 'transformers==4.38.2'"
