...
class PreTrainedBertModel(nn.Module):
    ...
    def from_pretrained(cls,
                        ...
                        **kwargs):
        """
        Instantiate a PreTrainedBertModel from a pre-trained model file or a pytorch state dict. # noqa
...
class BertModel(PreTrainedBertModel):
    ...
    Inputs:
        ...
        `output_all_encoded_layers`: boolean which controls the content of the `encoded_layers` output as described below. Default: `True`. # noqa
