...
docker_file_content="${docker_file_content} \nRUN export COMMIT_ID=$BUILD_HASH_ID && pip install --no-cache-dir -U --upgrade-strategy eager adaseq pai-easycv 'ms-swift==1.7.1' 'funasr==1.0.14' autoawq timm 'transformers==4.38.2'"
